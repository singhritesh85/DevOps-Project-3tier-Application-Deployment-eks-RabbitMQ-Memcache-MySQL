...
##############################Parameters to launch RabbitMQ EC2#############################
...
kms_key_id = "arn:aws:kms:us-east-2:0XXXXXXXXXX:key/XXXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXX"   ### Provide the ARN of KMS Key.

#env = ["dev", "stage", "prod"]

################################Parameters to create ALB############################

application_loadbalancer_name = "RabbitMQ-ALB"
internal = false
load_balancer_type = "application"
#subnets = ["subnet-XXXXXXXXXXXXXXXX", "subnet-XXXXXXXXXXXXXXX", "subnet-XXXXXXXXXXXXXX"]
...
access_log_bucket = "s3bucketcapturealblograbbitmq" ### S3 Bucket into which the Access Log will be captured
prefix = "application_loadbalancer_log_folder"
idle_timeout = 60
enabled = true
target_group_name = "RabbitMQ"
instance_port = 15672
...
certificate_arn = "arn:aws:acm:us-east-2:0XXXXXXXXXX:certificate/XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXX"
...
#  backup_retention_period = 7   ### For Demo purpose I am not creating any db backup.
  kms_key_id_rds = "arn:aws:kms:us-east-2:02XXXXXXXXX6:key/XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXX"
